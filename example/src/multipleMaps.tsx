...
const MultipleMapsScreen = () => {
  ...
  const [shouldShowMapControls1, setShouldShowMapControls1] = useState(false);
  const [shouldShowMapControls2, setShouldShowMapControls2] = useState(false);
  ...
  const onShowNavControlsClick = () => {
    setShouldShowMapControls1(false);
    setShouldShowMapControls2(false);
    setShouldShowNavControls(!shouldShowNavControls);
  };

  const onShowMapsControlsClick1 = () => {
    const newState = !shouldShowMapControls1;
    setShouldShowNavControls(false);
    setShouldShowMapControls1(newState);
    setShouldShowMapControls2(false);
  };

  const onShowMapsControlsClick2 = () => {
    const newState = !shouldShowMapControls2;
    setShouldShowNavControls(false);
    setShouldShowMapControls1(false);
    setShouldShowMapControls2(newState);
  };
  ...
  const mapViewCallbacks1: MapViewCallbacks = {
    onMapReady,
  ...
  const mapViewCallbacks2: MapViewCallbacks = {
    onMapReady,
    onMarkerClick: (marker: Marker) => {
      ...
      {mapViewController1 != null ? (
        <View style={styles.controlView}>
          <MapsControls
            ...
            visible={shouldShowMapControls1}
          />
        </View>
      ) : null}
      {mapViewController2 != null ? (
        <View style={styles.controlView}>
          <MapsControls
            ...
            visible={shouldShowMapControls2}
          />
        </View>
      ) : null}
