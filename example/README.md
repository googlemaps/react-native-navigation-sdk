...
1. Using your preferred terminal, go to example/ios folder and run the command below.
   ...
   Note: This example app requires React Native's new architecture and dynamic framework linkage, both configured in the Podfile. Open `SampleApp.xcworkspace` in Xcode after installing pods.
