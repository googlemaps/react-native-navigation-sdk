...
object ManeuverConverter {
  ...
  private val MANEUVER_TO_ANDROID_AUTO_MANEUVER_TYPE: ImmutableMap<Int, Int> =
    ImmutableMap.builder<Int, Int>()
      ...
      .put(Maneuver.TURN_RIGHT, androidx.car.app.navigation.model.Maneuver.TYPE_TURN_NORMAL_RIGHT)
      ...
      .put(
        ...
        androidx.car.app.navigation.model.Maneuver.TYPE_ROUNDABOUT_ENTER_AND_EXIT_CW_WITH_ANGLE,
      )
      .put(
   ...
   * direction [Maneuver]
   *
   * @throws [IllegalArgumentException] if the given maneuver does not have a corresponding Android
   *   Auto Maneuver type.
   */
  @JvmStatic
  ...
  /**
   * Returns the corresponding Android Auto roundabout angle for the given turn [Maneuver]. Returns
   * `null` if given maneuver does not involve a roundabout with a turn.
   */
  fun getAndroidAutoRoundaboutAngle(@Maneuver maneuver: Int): Int? {
    if (
      maneuver == Maneuver.ROUNDABOUT_LEFT_CLOCKWISE ||
    ...
    if (
      maneuver == Maneuver.ROUNDABOUT_SHARP_LEFT_CLOCKWISE ||
    ...
    if (
      maneuver == Maneuver.ROUNDABOUT_SLIGHT_LEFT_CLOCKWISE ||
    ...
    if (
      maneuver == Maneuver.ROUNDABOUT_U_TURN_CLOCKWISE ||
