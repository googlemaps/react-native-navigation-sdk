...
export interface GroundOverlay {
  ...
  position: LatLng;
  /** A LatLngBounds which will contain the image. Use either this or the position to define the position of the GroundOverlay. */
  bounds: LatLngBounds;
  /** Id of the GroundOverlay. The id will be unique amongst all GroundOverlays on a map. */
  id: string;
  ...
  transparency ?: number;
  /** The zIndex of the GroundOverlay. */
  zIndex?: number;
}
