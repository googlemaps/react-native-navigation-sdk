...
public class GMNNavForwardingManager {
  /** Registers a service to receive navigation updates from nav info */
  public static void startNavForwarding(
      Navigator navigator, Context context, IGMNNavigationCallback navigationCallback) {
    boolean success =
        navigator.registerServiceForNavUpdates(
            context.getPackageName(),
            GMNNavInfoReceivingService.class.getName(),
